...
exports.getAIRecommendation = async (req, res) => {
  try {
    ...
    const prompt = `
      Eres "Magma Bot", un asistente de turismo experto y amigable de la app creada por MAGMA CREW en Lambayeque, Perú.
      ...
      3. Responde a la consulta del usuario de forma amigable.
